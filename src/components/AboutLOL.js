  ...
  return (
    <>
      <div className="about-lol">
        ...
        <h3 className="about-lol-sub-heading" data-aos="zoom-in-down" data-aos-duration="1500">
          💻 Know about our Coding Community 🚀
        </h3>

        <div className="about-lol-content">
          <div className="about-lol-content-left" data-aos="zoom-in" data-aos-duration="1500">
          ...
          <div className="about-lol-content-right" data-aos="zoom-in" data-aos-duration="1500">
            <div className="about-lol-content-img">
